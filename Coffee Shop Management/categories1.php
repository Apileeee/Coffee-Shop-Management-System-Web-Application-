...
<head>
    ...
    <title>CATEGORI COFFEE ONE PIECE</title>
...
<section class="bg-dark text-white service p-5" id="menu">
    <div class="container text-center">
      ...
      <h4 class="display-6" style="color: orange;">COF<span style="color: blue;">FEE</span></h4>
      <p>
        Nikmati aroma dan rasa kopi terbaik dari biji kopi pilihan kami !
    </p>
</div>
</div>
<div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
        ...
        <div class="card h-20 bg-dark">
          ...
          <div class="card-body">
            <h5 class="card-title" style="color: orange;">CAPU<span style="color: blue;">CINNO</h5>
...
<div class="col">
  ...
  <div class="card h-20 bg-dark">
    <img src="img/moc.jpg" class="card-img-top" alt="..." height="235">
    <div class="card-body">
      <h5 class="card-title" style="color: orange;">MOC<span style="color: blue;">HA</h5>
...
<div class="col">
    ...
    <div class="card h-20 bg-dark">
        <img src="img/esp.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h5 class="card-title" style="color: orange;">ESPR<span style="color: blue;">ESSO</h5>
...
<div class="col">
  ...
  data-aos-duration="1000">
  <div class="card h-20 bg-dark">
    <img src="img/ame.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title" style="color: orange;">AMER<span style="color: blue;">ICANO</h5>
...
<div class="col">
  ...
  data-aos-duration="1500">
  <div class="card h-20 bg-dark">
    <img src="img/flat.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title" style="color: orange;">FLAT<span style="color: blue;">WHITE</h5>
          <p class="card-text">Rp 25.000</p>
      </div>
  </div>
</div>
...
<div class="col">
  ...
  data-aos-duration="2000">
  <div class="card h-20 bg-dark">
    <img src="img/afo.jpg" class="card-img-top" alt="..." height="200">
    <div class="card-body">
      <h5 class="card-title" style="color: orange;">AFFO<span style="color: blue;">GATO</h5>
          <p class="card-text">Rp 20.000</p>
      </div>
  </div>
</div>
