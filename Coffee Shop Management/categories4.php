...
<head>
    ...
    <title>CATEGORI FRAPPE | ONE PIECE</title>
...
<section class="bg-dark text-white service p-5" id="menu">
    <div class="container text-center">
      ...
      <h4 class="display-6" style="color: orange;">FRA<span style="color: blue;">PPE</span></h4>
      <p>
        Merambahlah ke dunia nikmat yang sejuk dengan pilihan frappe kami !
    </p>
</div>
</div>
<div class="container">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
        ...
        <div class="card h-20 bg-dark">
          <img src="img/straw.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title" style="color: orange;">STRAWBERRY<span style="color: blue;"> FRAPPE</h5>
...
<div class="col">
  ...
  <div class="card h-20 bg-dark">
    <img src="img/blue.jpg" class="card-img-top" alt="..." height="200">
    <div class="card-body">
      <h5 class="card-title" style="color: orange;">BLUEBERRY<span style="color: blue;"> FRAPPE</h5>
          <p class="card-text">Rp 15.000</p>
      </div>
  </div>
</div>
...
<div class="col">
    ...
    <div class="card h-20 bg-dark">
        <img src="img/mango.jpg" class="card-img-top" alt="..." height="200">
        <div class="card-body">
            <h5 class="card-title" style="color: orange;">MANGGO<span style="color: blue;"> FRAPPE</h5>
                <p class="card-text">Rp 15.000</p>
            </div>
        </div>
    </div>
